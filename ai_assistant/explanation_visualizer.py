...
class ExplanationVisualizer:
    ...
    def _load_color_schemes(self) -> Dict[ColorTheme, Dict[str, Any]]:
        ...
        return {
            ColorTheme.FINANCIAL: {
                ...
                "palette": ["#2E8B57", "#DC143C", "#4169E1", "#FF8C00", "#9370DB"]
            },
    ...
    def _load_html_templates(self) -> Dict[str, str]:
        ...
        return {
            ...
            <div class="footer">
                <p>Generated by AI Assistant Explainability Service</p>
    ...
    def create_summary_dashboard(
        ...
        try:
            ...
            # Generate insights
            insights = self._generate_insights(explanation_results, prediction, confidence)
            insights_html = "".join([f"<li>{insight}</li>" for insight in insights])
            
            # Generate recommendations
            recommendations = self._generate_recommendations(explanation_results, prediction, confidence)
            recommendations_html = "".join([f"<li>{rec}</li>" for rec in recommendations])
            
            # Create summary
            summary = self._create_explanation_summary(explanation_results, model_name, prediction, confidence)
    ...
    def get_theme_preview(self, theme: ColorTheme) -> Dict[str, str]:
