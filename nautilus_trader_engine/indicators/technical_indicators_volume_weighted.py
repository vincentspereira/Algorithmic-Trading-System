...
# 7) IntraDay Annual Volatility (IAV):
def IAV():
    """
...
# 14) Volume Weighted SMA:
def VW_SMA():
    """
    Volume Weighted SMA of Open (13, 34, 55 Period)
    Volume Weighted SMA of High (5, 13 Period)
    Volume Weighted SMA of Low (5, 13 Period)
    Volume Weighted SMA of MFI (21, 34 Period)

    VM SMA Crossovers can be used for Entries and Exits

    55 Period VWSMA can be used as Trend Finder
    If (Curr_SMA > Prev_SMA > Prev-1_SMA) => Up Trend and if (Curr_SMA < Prev_SMA < Prev-1_SMA) => Down Trend
    """
    pass


# 15) Volume Weighted EMA:
def VW_EMA():
    """
    Volume Weighted EMA of Open (13 Period)
    Volume Weighted EMA of HLC Average (5 Period)
    Volume Weighted EMA of MACD (9 Period)

    Can be used as Trend Finder
    """
    pass
