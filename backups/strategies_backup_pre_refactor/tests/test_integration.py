...
class ModuleImportTests(unittest.TestCase):
    ...
    def test_strategy_imports(self):
        ...
        modules_to_test = [
            'nautilus_trader_engine.strategies.mean_reversion.rsi2_mean_reversion_strategy',
            'nautilus_trader_engine.strategies.backtesting',
            'nautilus_trader_engine.strategies.backtesting.config',
            'nautilus_trader_engine.strategies.backtesting.results',
            'nautilus_trader_engine.strategies.backtesting.metrics',
            'nautilus_trader_engine.strategies.backtesting.backtest_engine',
            'nautilus_trader_engine.strategies.backtesting.performance_analyzer',
            'nautilus_trader_engine.strategies.backtesting.risk_analyzer',
            'nautilus_trader_engine.strategies.backtesting.visualization',
            'nautilus_trader_engine.strategies.backtesting.integration'
        ]
    ...
    def test_backtesting_classes(self):
        ...
        try:
            from nautilus_trader_engine.strategies.backtesting import (
                BacktestEngine,
                BacktestConfig,
                PerformanceAnalyzer,
                RiskAnalyzer,
            ...
            from nautilus_trader_engine.strategies.backtesting.results import BacktestResults
...
class StrategyIntegrationTests(unittest.TestCase):
    ...
    def test_strategy_signal_generation(self):
        ...
        try:
            from nautilus_trader_engine.strategies.mean_reversion.rsi2_mean_reversion_strategy import (
                create_rsi2_strategy, StrategyConfig
            )
            ...
            # Test strategy creation and basic properties
            self.assertIsNotNone(strategy)
            
            # Test that strategy has required attributes
            self.assertTrue(hasattr(strategy, 'strategy_config'))
            self.assertIsNotNone(strategy.strategy_config)
            self.assertTrue(hasattr(strategy, 'regime_classifier'))
            self.assertIsNotNone(strategy.regime_classifier)
            self.assertTrue(hasattr(strategy, 'bars_data'))
            self.assertTrue(hasattr(strategy, 'signals_history'))
            
            # Test config parameters
            self.assertEqual(strategy.strategy_config.rsi_short_period, 2)
            self.assertEqual(strategy.strategy_config.rsi_oversold, 10.0)
            self.assertEqual(strategy.strategy_config.rsi_overbought, 90.0)
            
            logger.info("Strategy creation and configuration test passed")
    ...
    def test_regime_classification(self):
        ...
        try:
            from nautilus_trader_engine.strategies.core.mean_reversion.rsi2_mean_reversion_strategy import (
                MarketRegimeClassifier,
                StrategyConfig
            )
...
class BacktestingFrameworkTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from nautilus_trader_engine.strategies.backtesting.config import (
            BacktestConfig,
            TransactionCosts,
            RiskLimits
        )
    ...
    def test_backtest_engine_creation(self):
        ...
        try:
            from nautilus_trader_engine.strategies.backtesting.backtest_engine import BacktestEngine
    ...
    def test_performance_metrics_calculation(self):
        ...
        try:
            from nautilus_trader_engine.strategies.backtesting.metrics import MetricsCalculator
            from nautilus_trader_engine.strategies.backtesting.results import Trade, BacktestResults
            
            # Create sample trades
            from nautilus_trader_engine.strategies.backtesting.results import TradeType
...
class AsyncIntegrationTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_async_backtest_execution(self):
        ...
        try:
            from nautilus_trader_engine.strategies.backtesting.backtest_engine import BacktestEngine
            from nautilus_trader_engine.strategies.backtesting.config import BacktestConfig
            from nautilus_trader_engine.strategies.mean_reversion.rsi2_mean_reversion_strategy import (
                create_rsi2_strategy
            )
    ...
    async def test_kafka_integration(self):
        ...
        try:
            from nautilus_trader_engine.strategies.backtesting.integration import KafkaEventStreamer, KafkaConfig
            ...
            # Mock Kafka producer
            with patch('nautilus_trader_engine.strategies.backtesting.integration.KafkaProducer') as mock_producer:
...
class VisualizationTests(unittest.TestCase):
    ...
    def test_visualization_engine_creation(self):
        ...
        try:
            from nautilus_trader_engine.strategies.backtesting.visualization import VisualizationEngine
            from nautilus_trader_engine.strategies.backtesting.results import BacktestResults
...
class RiskAnalysisTests(unittest.TestCase):
    ...
    def test_var_calculation(self):
        ...
        try:
            from nautilus_trader_engine.strategies.backtesting.risk_analyzer import RiskAnalyzer
